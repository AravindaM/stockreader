...
class Domain:
    ...
    def __init__(self, mongo, influx, download):
        self.mongo = mongo
        self.influx = influx
    ...
    def download_and_save_stock_current_data(self, stock):
        ...
        self.influx.update_stock_current_data(quote, stock_current_data)
    ...
    def download_and_save_stock_historical_data(self, initialDate, finalDate, stock):
        ...
        self.influx.save_stock_historical_data(quote, stock_historical_data_array)
